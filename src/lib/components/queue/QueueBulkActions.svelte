							...
							<AlertDialog.Header>
								...
								<AlertDialog.Description>
									Set the search priority for {selectedCount} selected item{selectedCount === 1
										? ''
										: 's'}. Higher values will be searched first.
								</AlertDialog.Description>
							</AlertDialog.Header>
					...
					<AlertDialog.Portal>
						...
						<AlertDialog.Content>
							<AlertDialog.Header>
								...
								<AlertDialog.Description>
									Are you sure you want to remove {selectedCount} item{selectedCount === 1
										? ''
										: 's'} from the queue? Items will be reset to pending state and can be re-queued later.
								</AlertDialog.Description>
							</AlertDialog.Header>
							<AlertDialog.Footer>
