...
from comradarr_dev.tui.screens.dialogs import ConfirmDialog, StopAndDeleteDialog
...
class DatabaseManagementScreen(Screen[None]):
    ...
    async def _stop_server_and_delete(self, db_name: str) -> None:
        ...
        from comradarr_dev.commands import stop
    ...
    async def _delete_database(self, db_name: str) -> None:
        """Delete a database."""
        from comradarr_dev.commands.dev import drop_database
        from comradarr_dev.core.platform import detect_platform, get_strategy
        from comradarr_dev.core.state import remove_credentials
